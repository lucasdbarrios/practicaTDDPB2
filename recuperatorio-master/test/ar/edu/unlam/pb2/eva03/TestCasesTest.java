...
public class TestCasesTest {
	...
	public void queSePuedaCrearUnObjetoVolador() {
		...
		assertEquals("A-10",((Vehiculo)avion).getNombre());
	} 
	...
	@Test (expected = VehiculoExistenteException.class)
	public void queSiSeArmaUnConvoyYHayUnVehiculoRepetidoSalteUnaExcepcion() throws VehiculoExistenteException {
	...
	@Test 
	public void queSepuedaArmarUnConvoy() throws VehiculoExistenteException {
		FuerzaArmada argentina = new FuerzaArmada();
	...
	@Test
	public void queSePuedaCrearUnaBatalla() throws BatallaDuplicadaException {
		FuerzaArmada argentina = new FuerzaArmada();
	...
	public void queSePuedaPresentarBatallaTerrestre() throws VehiculoInexistente, VehiculoIncompatible, VehiculoExistenteException, BatallaDuplicadaException, BatallaInexistenteException {
		FuerzaArmada argentina = new FuerzaArmada();
	...
	@Test
	public void queSePuedaPresentarBatallaNaval() throws VehiculoInexistente, VehiculoIncompatible, VehiculoExistenteException, BatallaDuplicadaException, BatallaInexistenteException {
		FuerzaArmada argentina = new FuerzaArmada();
	...
	public void queSeNoSePuedaEnviarAUnaBatallaEnTierraUnBarco() throws VehiculoInexistente, VehiculoIncompatible, VehiculoExistenteException, BatallaDuplicadaException, BatallaInexistenteException {
		FuerzaArmada argentina = new FuerzaArmada();
	...
	public void queSeNoSePuedaEnviarAUnaBatallaUnVehiculoQueNoExista() throws VehiculoInexistente, VehiculoIncompatible, VehiculoExistenteException, BatallaDuplicadaException, BatallaInexistenteException {
		FuerzaArmada argentina = new FuerzaArmada();
