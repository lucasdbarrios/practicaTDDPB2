...
public class TestCaseDeportivo {
	...
	@Test
	public void  queSePuedanIncorporarDistintosDeportistas() throws SocioExistenteException {
	...
	@Test(expected = SocioExistenteException.class)
	public void  queSiSePuedanIncorporarDistintosDeportistasYHayUnNroSocioDuplicadoSalgaUnaExcepcion() throws SocioExistenteException {
		// El n�mero de socio no se puede repetir
		Club actual = new Club("CARP");
	...
	public void  queUnCorredorNoSePuedaInscribirEnUnaCarreraDeNatacion () throws NoEstaPreparado, SocioExistenteException{	
