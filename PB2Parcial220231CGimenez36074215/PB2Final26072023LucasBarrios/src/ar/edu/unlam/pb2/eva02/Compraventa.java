...
public class Compraventa {
	...
	public void realizarVentaDeArticulo(Integer dni, Integer codigoArticulo) throws VentaExistenteException {
		if(ventas.containsKey(numeroDeVenta)) {
			throw new VentaExistenteException();
		}
//		Compradores compradorBuscado = BuscarCompradorPorDni(dni);
//		Articulo articuloBuscado = BuscarArticuloPorCodigo(codigoArticulo);
//		Venta nuevaVenta 
