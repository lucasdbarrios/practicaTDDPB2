...
//			assertEquals((Integer)2, elLitoral.CantidadDeProductosEnCombo(numeroCombo));
	...
	@Test
	public void queSePuedaIngresarUnaVentaDeUnArticuloAlCompraventa() throws ProductoExistenteException, ComboExistenteException, ComboInexistenteException, TipoArticuloInvalidoException, CompradorExistenteException {
		Integer CodigoArticulo =1;
		Articulo producto = new Antiguedad(CodigoArticulo, "Jarron", 9000, "jarron florentino", 1, TipoArticulo.ANTIGUEDAD);
		Articulo producto2 = new Antiguedad(2, "Florero", 9500, " florentino", 1, TipoArticulo.ANTIGUEDAD);
		...
		elLitoral.ingresarComprador(nuevoComprador);
		
//		elLitoral.realizarVentaDeArticulo(dni,CodigoArticulo); FALTA COMPLETAR
